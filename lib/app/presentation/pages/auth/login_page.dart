...
class _LoginPageState extends State<LoginPage> {
      ...
      listener: (context, state) {
        if (state is LoginSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('Welcome ${state.data.user?.name}! 🎉'),
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // Debug: Reset First Launch Button
                          TextButton(
                            onPressed: () async {
                              ...
                              if (mounted) {
                                ScaffoldMessenger.of(scaffoldContext)
                                  ...
                                  const SnackBar(
                                    content: Text(
                                        'First launch reset! Restart app to see Welcome Page.'),
                                    backgroundColor: Colors.green,
  ...
  Widget _buildTitleSection() {
    return Column(
      children: [
        // Title dengan 3D Glasses Effect
        Stack(
          children: [
            // Red shadow (kiri atas)
            Text(
              'Piggyku',
              style: TextStyle(
                fontSize: 36,
            ...
            child: isLoading
                ? const SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      strokeWidth: 2.5,
                      valueColor:
                          AlwaysStoppedAnimation<Color>(Color(0xFFB4F000)),
                    ),
                  )
                : const Text(
                    'Masuk 🚀',
